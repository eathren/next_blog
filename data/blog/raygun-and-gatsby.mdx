...
tags:
  ...
  - raygun
draft: false
summary: Getting Raygun to work with Gatsby.js
---
...
The wrapper is then used with all the content inside of gatsby-browser _(read: absolutely every other part of your rendered app)_ with the help of the wrapRootElement api.
